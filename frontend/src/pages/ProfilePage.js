        ...
        const handleSubmit = async (e) => {
               ...
               try {
                   ...
                   if (response.status === 200) {
                       toast.success(result.message || 'Profile Updated Succesfully');
                ...
                <form onSubmit={handleSubmit} className='card p-4 shadow-sm border-0'>
                    <div className='row'>
                        ...
                        <div className='col-md-6 mb-3'>
                            ...
                            <input type='text' className='form-control'  value={formData.mobile_number} onChange={handleChange}/>
                        </div>

                        <div className='col-md-6 mb-3'>
                            <label className='mb-1'>Registration  Date</label>
                            <input type='text' className='form-control'value={new Date(formData.reg_date).toLocaleString()}onChange={handleChange} disabled/>
                        </div>
