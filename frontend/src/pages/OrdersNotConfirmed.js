      ...
      const navigate = useNavigate();
                ...
                useEffect(() => {
                 const fetchOrders = async () => {
                   try {
                     const res = await fetch('http://127.0.0.1:8000/api/orders-not-confirmed/');
    ...
    <AdminLayout>
            <div>
                <h3 className='text-center text-primary mb-4'>
                    <i className='fas fa-list-alt me-1'></i>Details of Orders Not Confirmed
                </h3>
                ...
                <div className='mb-3'>
                    <input type='text' className='form-control w-50' placeholder='Search For Product'></input></div>
